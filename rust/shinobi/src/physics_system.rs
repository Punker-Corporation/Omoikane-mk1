...
impl PhysicsSystem {
    ...
    pub(crate) fn update(&mut self, entities: &mut ClientEntityManager, frame_time: f32) {
        ...
        for uid in bodies {
            ...
            if entities.inner.offset_local_transform_immediate(
                uid,
        ...
        entities
            .inner
            .refresh_map_physics_runtime_many(affected_maps);
    }
}
...
mod tests {
    ...
    fn physics_system_integrates_dynamic_bodies() {
        ...
        entities.inner.mutate_physics_and_reconcile(uid, |body| {
        ...
        entities
            .inner
            .refresh_broadphase_runtime(broadphase_uid, &[uid]);
        assert_eq!(
            entities
                .inner
                .transforms
        ...
        assert_eq!(
            entities
                .inner
                .query_aabb_entities(broadphase_uid, Box2::new(-1.0, -2.0, 3.0, 2.0)),
            vec![uid]
        );
        assert_eq!(
    ...
    fn physics_system_keeps_predicted_spatial_runtime_in_sync() {
        ...
        entities
            .inner
            .ensure_map_physics_runtime(sekai::MapId::new(2));
    ...
    fn physics_system_keeps_predicted_contact_runtime_in_sync() {
        ...
        entities
            .inner
            .ensure_map_physics_runtime(sekai::MapId::new(3));
        ...
        entities
            .inner
            .refresh_map_physics_runtime_many([sekai::MapId::new(3)]);
    ...
    fn physics_system_keeps_predicted_mixed_contact_manifold_in_sync() {
        ...
        entities
            .inner
            .ensure_map_physics_runtime(sekai::MapId::new(4));
        ...
        entities
            .inner
            .refresh_map_physics_runtime_many([sekai::MapId::new(4)]);
    ...
    fn physics_system_intersect_ray_first_hit_returns_closest_entity() {
        ...
        entities.inner.initialize_entity(broadphase_uid);
        entities.inner.ensure_broadphase(broadphase_uid);
        ...
        entities
            .inner
            .refresh_broadphase_runtime(broadphase_uid, &[far, near]);
    ...
    fn physics_system_predicted_runtime_ignores_circle_aabb_false_contacts() {
        ...
        entities
            .inner
            .ensure_map_physics_runtime(sekai::MapId::new(10));
        ...
        entities
            .inner
            .refresh_map_physics_runtime_many([sekai::MapId::new(10)]);
    ...
    fn physics_system_predicted_runtime_ignores_rotated_aabb_false_contacts() {
        ...
        entities
            .inner
            .ensure_map_physics_runtime(sekai::MapId::new(11));
        ...
        entities
            .inner
            .refresh_map_physics_runtime_many([sekai::MapId::new(11)]);
    ...
    fn physics_system_update_applies_gravity_and_auto_clears_forces_for_predicted_bodies() {
        ...
        assert!(
            entities
                .inner
                .set_map_gravity(sekai::MapId::new(9), Vector2::new(0.0, -10.0))
        );
        assert!(
            entities
                .inner
                .set_map_auto_clear_forces(sekai::MapId::new(9), true)
        );
    ...
    fn physics_system_update_puts_idle_predicted_bodies_to_sleep_and_updates_runtime() {
        ...
        entities
            .inner
            .refresh_map_physics_runtime_many([sekai::MapId::new(12)]);
        assert!(
            entities
                .inner
                .map_contains_awake_body(sekai::MapId::new(12), uid)
        );
