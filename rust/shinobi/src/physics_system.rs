...
mod tests {
    ...
    fn physics_system_integrates_dynamic_bodies() {
        ...
        entities.inner.broadphases.insert(broadphase_uid, sekai::BroadphaseComponent::new());
    ...
    fn physics_system_keeps_predicted_spatial_runtime_in_sync() {
        ...
        entities
            .inner
            .ensure_fixtures(uid)
            .insert_fixture(Fixture::new("main", PhysShape::Aabb(AabbShape::new(Box2::new(-0.5, -0.5, 0.5, 0.5), 0.0))));
    ...
    fn physics_system_intersect_ray_first_hit_returns_closest_entity() {
        ...
        let system = PhysicsSystem::new();
        sekai::SharedPhysicsSystem.sync_broadphase(&mut entities.inner, broadphase_uid, &[far, near]);
